package com.agile.websocket.common.aspect;

import com.agile.websocket.common.annotation.Cache;
import com.agile.websocket.common.util.CacheKeyGenerator;
...
public class CacheAspect implements Ordered {
    ...
    @Around("@annotation(com.agile.websocket.common.annotation.Cache)")
